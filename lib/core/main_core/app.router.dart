...
import 'package:queen_plate_delivery/screens/auth/views/onboarding_view.dart'
    as _i21;
import 'package:queen_plate_delivery/screens/auth/views/otp_view.dart' as _i7;
...
class Routes {
  ...
  static const emailVerifyOtp = '/email-verify-otp';
...
class StackedRouter extends _i1.RouterBase {
  final _routes = <_i1.RouteDef>[
    ...
    _i1.RouteDef(
      ...
      page: _i5.EmailVerifyOtp,
    ),
    _i1.RouteDef(
      Routes.forgetPasswordView,
      page: _i6.ForgetPasswordView,
    ),
    _i1.RouteDef(
      Routes.otpView,
      page: _i7.OtpView,
    ...
    _i1.RouteDef(
      ...
      page: _i12.OrderTrackingView,
    ),
    _i1.RouteDef(
      Routes.orderHistoryView,
      page: _i13.OrderHistoryView,
    ),
    _i1.RouteDef(
      Routes.deliveryDetailsView,
      page: _i14.DeliveryDetailsView,
    ),
    _i1.RouteDef(
      Routes.editDeliveryDetailView,
      page: _i15.EditDeliveryDetailView,
    ),
    _i1.RouteDef(
      Routes.contactUsView,
      page: _i16.ContactUsView,
    ),
    _i1.RouteDef(
      Routes.feedbackView,
      page: _i17.FeedbackView,
    ),
    _i1.RouteDef(
    ...
    _i1.RouteDef(
      ...
      page: _i19.ChangePasswordView,
    ),
    _i1.RouteDef(
      Routes.paystackWebView,
      page: _i20.PaystackWebView,
    ),
    _i1.RouteDef(
      Routes.onboardingView,
      page: _i21.OnboardingView,
    ),
  ];
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i5.EmailVerifyOtp: (data) {
      final args = data.getArgs<EmailVerifyOtpArguments>(nullOk: false);
      return _i23.CupertinoPageRoute<dynamic>(
        builder: (context) => _i5.EmailVerifyOtp(
            key: args.key, email: args.email, pass: args.pass),
        settings: data,
      );
    },
    _i6.ForgetPasswordView: (data) {
      return _i23.CupertinoPageRoute<dynamic>(
        builder: (context) => const _i6.ForgetPasswordView(),
        settings: data,
      );
    },
    _i7.OtpView: (data) {
    ...
    _i9.FoodMenuDetailView: (data) {
      final args = data.getArgs<FoodMenuDetailViewArguments>(nullOk: false);
      return _i23.CupertinoPageRoute<dynamic>(
        builder: (context) => _i9.FoodMenuDetailView(
            key: args.key,
    ...
    _i10.CheckoutView: (data) {
      return _i23.CupertinoPageRoute<dynamic>(
        builder: (context) => const _i10.CheckoutView(),
        settings: data,
      );
    },
    _i11.OrderSuccessView: (data) {
      ...
      return _i23.CupertinoPageRoute<dynamic>(
        builder: (context) => _i11.OrderSuccessView(
            key: args.key, orderId: args.orderId, address: args.address),
        settings: data,
      );
    },
    _i12.OrderTrackingView: (data) {
      final args = data.getArgs<OrderTrackingViewArguments>(nullOk: false);
      return _i23.CupertinoPageRoute<dynamic>(
        builder: (context) => _i12.OrderTrackingView(
            key: args.key, orderId: args.orderId, orderInfo: args.orderInfo),
        settings: data,
      );
    },
    _i13.OrderHistoryView: (data) {
      return _i23.CupertinoPageRoute<dynamic>(
        builder: (context) => const _i13.OrderHistoryView(),
        settings: data,
      );
    },
    _i14.DeliveryDetailsView: (data) {
      return _i23.CupertinoPageRoute<dynamic>(
        builder: (context) => const _i14.DeliveryDetailsView(),
        settings: data,
      );
    },
    _i15.EditDeliveryDetailView: (data) {
      return _i23.CupertinoPageRoute<dynamic>(
        builder: (context) => const _i15.EditDeliveryDetailView(),
        settings: data,
      );
    },
    _i16.ContactUsView: (data) {
      return _i23.CupertinoPageRoute<dynamic>(
        builder: (context) => const _i16.ContactUsView(),
        settings: data,
      );
    },
    _i17.FeedbackView: (data) {
      return _i23.CupertinoPageRoute<dynamic>(
        builder: (context) => const _i17.FeedbackView(),
        settings: data,
      );
    },
    ...
    _i21.OnboardingView: (data) {
      return _i23.CupertinoPageRoute<dynamic>(
        builder: (context) => const _i21.OnboardingView(),
        settings: data,
      );
    },
  };
...
class EmailVerifyOtpArguments {
  const EmailVerifyOtpArguments({
    this.key,
    required this.email,
    required this.pass,
  });
  ...
  @override
  String toString() {
    return '{"key": "$key", "email": "$email", "pass": "$pass"}';
  }

  @override
  bool operator ==(covariant EmailVerifyOtpArguments other) {
    if (identical(this, other)) return true;
    return other.key == key && other.email == email && other.pass == pass;
  }

  @override
  int get hashCode {
    return key.hashCode ^ email.hashCode ^ pass.hashCode;
  }
}
...
class OrderTrackingViewArguments {
  ...
  final _i24.OrderData orderInfo;
...
extension NavigatorStateExtension on _i25.NavigationService {
  ...
  Future<dynamic> navigateToEmailVerifyOtp({
    _i22.Key? key,
    ...
    return navigateTo<dynamic>(Routes.emailVerifyOtp,
        arguments: EmailVerifyOtpArguments(key: key, email: email, pass: pass),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> navigateToOrderTrackingView({
    _i22.Key? key,
    required String orderId,
    required _i24.OrderData orderInfo,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
  ...
  Future<dynamic> replaceWithEmailVerifyOtp({
    _i22.Key? key,
    required String email,
    required String pass,
    int? routerId,
    ...
    return replaceWith<dynamic>(Routes.emailVerifyOtp,
        arguments: EmailVerifyOtpArguments(key: key, email: email, pass: pass),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
