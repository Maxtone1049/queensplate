...
import 'package:queen_plate_delivery/screens/auth/views/email_verify_otp.form.dart';
import 'package:stacked/stacked.dart';
import 'package:stacked/stacked_annotations.dart';

@FormView(fields: [FormTextField(name: 'otp')])
class EmailVerifyOtp extends StatelessWidget with $EmailVerifyOtp {
  const EmailVerifyOtp({super.key, required this.email, required this.pass});
